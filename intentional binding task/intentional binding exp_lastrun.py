...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\NCS\\Desktop\\NIRJA\\lab in psych\\intentional binding task\\intentional binding exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and and the beep sound (0-999);\nClick submit after entering the value',
        font='Arial',
